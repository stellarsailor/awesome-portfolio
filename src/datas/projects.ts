...
export const projects: Array<ProjectType> = [
    {
        ...
        title: 'SelfBingo',
        codeLink: '',
        liveLink: 'https://selfbingo.com',
        languages: 'English / Korean',
        timespent: 184,
        year: '2020',
        duration: '8.17 - 11.12',
        stack: ['React.js(Next.js)', 'MySQL(RDS)', 'AWS RDS'],
        profit: 'KaKao Adfit',
        library: '',
    ...
    },
    {
        ...
        title: 'Genshin Party',
        codeLink: '',
        liveLink: 'https://genshinparty.com',
        languages: 'English / Korean',
        year: '2020 - 2021',
        duration: '12.20. - 1. 1.',
        stack: ['React.js(Next.js)', 'AWS RDS(MySQL)', 'Vercel',],
        library: 'https://github.com/stellarsailor/genshinProject/blob/main/package.json',
