const TRANSLATIONS: {
  [key: string]: {
    ...
    MAIN_PERSONAL_PROJECTS: string;
    MAIN_RUNNING_SERVICES: string;
    MAIN_TOY_PROJECTS: string;
    MAIN_BUTTON_DESC: string;
    ABOUT_ME_COMMENT: string;
    CONTACT_COMMENT: string;
  }
} = {
  en: {
    MAIN_INTRODUCE: 'I am Minsu Lee. Love to write clean code with React and TypeScript. I always do my best to exceed others’ expectations.',
    MAIN_PERSONAL_PROJECTS: 'Personal Projects',
  ...
  ko: {
    MAIN_INTRODUCE: '반갑습니다. 저는 이민수 입니다. 자바스크립트와 리액트를 사랑하며 클린 코드를 작성하고 싶습니다. 언제나 타인의 기대를 뛰어넘기 위해 최선을 다합니다.',
    MAIN_PERSONAL_PROJECTS: '개인 프로젝트',
