...
export const projects: Array<ProjectType> = [
    {
        ...
        feature: ['Responsive', 'SSR', 'SEO', 'i18n (English/Korean)', 'Social Login', 'Serverless Back-End', 'HTTPS'],
        profit: 'KaKao Adfit',
    ...
    },
    {
        ...
        feature: ['SPA', 'Responsive', 'Pre-rendered by react-snapshot', 'SEO', 'RESTful Back-End', "HTTPS SSL(Let's Encrypt)"],
        profit: 'Google AdSense, KaKao Adfit / Google Admob(Mobile)',
        result: '220k Users, 400k Sessions on Google Analytics, 5k downloads on Google Play ( ~ Feb 2021)',
    ...
    },
    {
        ...
        year: '2019 - 2020',
        duration: '11.26. - 4.20.',
        stack: ['React Native', 'Redux', 'Node.js(Express.js)', 'NGINX', 'MySQL(EC2)', 'AWS S3/EC2', 'Microsoft App Center'],
        feature: ['i18n (English/Korean)', 'Social Login', 'RESTful Back-End', 'HTTPS'],
        profit: 'Google Admob',
    ...
    },
    {
        ...
        feature: ['SPA', 'Responsive', 'CSR', 'Serverless Back-End', 'i18n', 'HTTPS'],
